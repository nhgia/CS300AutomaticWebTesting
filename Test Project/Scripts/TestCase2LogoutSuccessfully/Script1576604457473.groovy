...
WebUI.click(findTestObject('Object Repository/Page_Town Square - Hello Mattermost/span'))

WebUI.click(findTestObject('Object Repository/Page_Town Square - Hello Mattermost/button_Logout'))
