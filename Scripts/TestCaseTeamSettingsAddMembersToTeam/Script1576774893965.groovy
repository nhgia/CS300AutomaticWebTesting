...
WebUI.click(findTestObject('Object Repository/Page_ Town Square - FirstTeam Mattermost/button_Add Members to Team'))

WebUI.setText(findTestObject('Object Repository/Page_ Town Square - FirstTeam Mattermost/input_Search and add members_react-select-2-input'), 
    'testingemail@gmail.com')

WebUI.click(findTestObject('Object Repository/Page_ Town Square - FirstTeam Mattermost/div_testingemailgmailcom_more-modal__action_e57966'))

WebUI.click(findTestObject('Object Repository/Page_ Town Square - FirstTeam Mattermost/button_Add'))
