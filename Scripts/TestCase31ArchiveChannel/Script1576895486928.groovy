...
WebUI.click(findTestObject('Page_Town Square - FirstTeam Mattermost/span_Channel1'))

WebUI.click(findTestObject('Page_Channel1 - FirstTeam Mattermost/span_Channel1_channelHeaderDropdownIcon'))

WebUI.click(findTestObject('Object Repository/Page_Channel1 - FirstTeam Mattermost/button_Archive Channel'))

WebUI.click(findTestObject('Object Repository/Page_Channel1 - FirstTeam Mattermost/span_Archive'))
