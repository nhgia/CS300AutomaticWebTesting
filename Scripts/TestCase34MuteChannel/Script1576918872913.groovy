...
WebUI.click(findTestObject('Page_Town Square - FirstTeam Mattermost/button_Town Square'))

WebUI.click(findTestObject('Object Repository/Page_Town Square - FirstTeam Mattermost/button_Mute Channel'))
