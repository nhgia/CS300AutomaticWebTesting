...
WebUI.click(findTestObject('Object Repository/Page_Town Square - FirstTeam Mattermost/span_Channel3'))

WebUI.click(findTestObject('Object Repository/Page_Channel3 - FirstTeam Mattermost/span_Channel3_channelHeaderDropdownIcon'))

WebUI.click(findTestObject('Object Repository/Page_Channel3 - FirstTeam Mattermost/button_Leave Channel'))
